# This migration comes from decidim_questions (originally 20210130043551)
class CreateDecidimQuestions < ActiveRecord::Migration[5.2]
  def change
    ...
    create_table "decidim_questions_valuation_assignments", force: :cascade do |t|
      t.bigint "decidim_question_id", null: false
      t.string "valuator_role_type", null: false
      t.bigint "valuator_role_id", null: false
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
      t.index ["decidim_question_id"], name: "decidim_questions_valuation_assignment_question"
      t.index ["valuator_role_type", "valuator_role_id"], name: "decidim_questions_valuation_assignment_valuator_role"
    end
  end
end
